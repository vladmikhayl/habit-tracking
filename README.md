...
**Backend:** Java, Spring Boot (Web, Security + JWT, Data JPA), Spring Cloud (Eureka, Config Server, Gateway), PostgreSQL, Kafka, _Amazon S3_, Swagger
...
[//]: # (Дописать что упор я делал на бэкенд и делал грамотную архитектуру)
